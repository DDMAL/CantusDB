...
class ChantCreateView(CustomAccessMixin, CreateView):  # type: ignore[type-arg]
    ...
    def form_valid(self, form):
        ...
        # Queue the success message only after the chant and its elements commit. If
        # element creation rolls the transaction back, the cookie-backed message store
        # would otherwise carry a "created" message for a chant that no longer exists.
        # The incipit is filled in by a post-save signal, so re-read it here.
